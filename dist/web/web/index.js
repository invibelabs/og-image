...
const App = (_, state, setState) => {
    ...
    const { fileType = 'png', fontSize = '125px', theme = 'purple', md = true, text = 'Imagine: High-quality Participant Voice Responses 🧠', images = [imageColorCardOptions[0].value], widths = [], heights = [], showToast = false, messageToast = '', loading = true, selectedImageIndex = 0, overrideUrl = null, } = state;
    ...
    return H('div', { className: 'split' }, H('div', { className: 'pull-left' }, H('div', H(Field, {
        ...
        input: H(Dropdown, {
            ...
            value: theme,
            onchange: (val) => setLoadingState({ theme: val })
        })
    }), H(Field, {
        label: 'File Type',
        input: H(Dropdown, {
