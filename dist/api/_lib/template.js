...
function getCss(theme, fontSize) {
    ...
    "Helvetica Neue Light", "Helvetica Neue", "Lucida Grande", "sans-serif";
        ...
        font-size: ${(0, sanitizer_1.sanitizeHtml)(fontSize)};
        font-style: normal;
        color: ${foreground};
        line-height: 1.2;
...
<html>
    ...
    <body>
        <div>
            ...
            <div class="spacer">
            <div class="heading">${emojify(md ? (0, marked_1.marked)(text) : (0, sanitizer_1.sanitizeHtml)(text))}
            </div>
        </div>
    </body>
</html>`;
...
function getImage(src, width = 'auto', height = '225') {
    return `<img
        class="logo"
        alt="Generated Image"
        src="${(0, sanitizer_1.sanitizeHtml)(src)}"
        width="${(0, sanitizer_1.sanitizeHtml)(width)}"
        height="${(0, sanitizer_1.sanitizeHtml)(height)}"
    />`;
}
